...
public class HodRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(HodRegistrationActivity.this);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (etName.getText().toString().isEmpty()) {
                    ...
                    progressDialog = new ProgressDialog(HodRegistrationActivity.this);
                    ...
                    Intent i = new Intent(HodRegistrationActivity.this, ChangeHodProfilePhotoActivity.class);
