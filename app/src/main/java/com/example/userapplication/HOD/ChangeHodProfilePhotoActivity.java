...
import com.example.userapplication.teacher.ChangeTeacherProfilePhotoActivity;
...
public class ChangeHodProfilePhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_hod_profile_photo);

        ivProfilePhoto = findViewById(R.id.ivChangeHODProfilePhotoImage);
        btnSaveProfilePhoto = findViewById(R.id.btnChangeHODProfilePhoto);
        btnNext = findViewById(R.id.btnChangeHODProfilePhotoNext);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog = new ProgressDialog(ChangeHodProfilePhotoActivity.this);
                ...
                PhoneAuthProvider.getInstance().verifyPhoneNumber("+91" + strMobileNo, 60, TimeUnit.SECONDS,
                        ChangeHodProfilePhotoActivity.this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            @Override
                            public void onVerificationCompleted(@NonNull PhoneAuthCredential phoneAuthCredential) {
                                progressDialog.dismiss();
                                Toast.makeText(ChangeHodProfilePhotoActivity.this, "Verification Completed", Toast.LENGTH_SHORT).show();
                            }

                            @Override
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                progressDialog.dismiss();
                                Toast.makeText(ChangeHodProfilePhotoActivity.this, "Verification Failed", Toast.LENGTH_SHORT).show();
                            }

                            @Override
                            public void onCodeSent(@NonNull String verificationCode, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                Intent i = new Intent(ChangeHodProfilePhotoActivity.this, HodVerifyActivity.class);
